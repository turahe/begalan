...
@section('content')
    ...
    <div class="curriculum-top-nav d-flex bg-white mb-5 p-2 border">
        <h4 class="flex-grow-1"><i class="las la-list-alt"></i> {{__t('curriculum')}} </h4>
                ...
                @foreach($course->sections as $section)
                    <div id="dashboard-section-{{$section->id}}" class="dashboard-course-section bg-white border mb-4">
                        <div class="dashboard-section-header p-3 border-bottom d-flex">
                            <i class="las la-bars section-move-handler"></i>

                            <span class="dashboard-section-name flex-grow-1 ml-2"><strong>{{$section->section_name}}</strong>
                            </span>

                            <button class="section-item-btn-tool btn px-1 py-0 section-edit-btn "><i class="las la-pencil"></i> </button>

                            <button class="section-item-btn-tool btn btn-outline-danger text-danger px-1 py-0 section-delete-btn ml-3" data-section-id="{{$section->id}}"><i class="las la-trash"></i> </button>
                        </div>
                        ...
                        <div class="card-body section-edit-form-wrap" style="display: none;">
                            <form action="{{route('update_section', $section->id)}}" method="post" class="section-edit-form">
                                ...
                                <button type="submit" class="btn btn-warning" name="save" value="save">
                                    <i class="las la-save"></i> {{__t('update_section')}}
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="section-add-item-wrap p-3 bg-dark">
                            <a href="javascript:;" class="add-item-lecture mr-3"> <i class="las la-plus-square"></i> {{__t('lecture')}}</a>
                            <a href="javascript:;" class="create-new-quiz mr-3"> <i class="las la-plus-square"></i> {{__t('quiz')}}</a>
                            <a href="javascript:;" class="new-assignment-btn mr-3"> <i class="las la-plus-square"></i> {{__t('assignments')}}</a>
                        </div>
                    </div>
                @endforeach
            </div>
                ...
                <div class="section-item-form-html  p-4 border">
                    ...
                    <form class="curriculum-lecture-form" action="{{route('new_lecture', $course->id)}}" method="post">
                        ...
                        <div class="form-group text-right">
                            ...
                            <button type="submit" class="btn btn-info btn-add-lecture"  name="save" value="save_next"> <i class="las la-save"></i> {{__t('add_lecture')}}</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div id="section-quiz-form-html" style="display: none;">
                <div class="section-item-form-html p-4 border">
                    ...
                    <form class="curriculum-quiz-form" action="{{route('new_quiz', $course->id)}}" method="post">
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-outline-info btn-cancel-form"> {{__t('cancel')}}</button>
                            <button type="submit" class="btn btn-info btn-add-quiz"  name="save" value="save_next"> <i class="las la-save"></i> {{__t('create_new_quiz')}}</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div id="new-assignment-form-html" style="display: none;">
                <div class="section-item-form-html p-4 border">
                    ...
                    <form class="new-assignment-form" action="{{route('new_assignment', $course->id)}}" method="post">
                        ...
                        <div class="form-group text-right">
                            <button type="button" class="btn btn-outline-info btn-cancel-form"> {{__t('cancel')}}</button>
                            <button type="submit" class="btn btn-info btn-add-assignment"  name="save" value="save_next"> <i class="las la-save"></i> {{__t('new_assignment')}}</button>
                        </div>
                    </form>
                </div>
            </div>
