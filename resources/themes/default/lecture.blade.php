...
@section('content')
    ...
    @include('default.template-part.content-navigation', ['content' => $lecture])

    <div class="lecture-container-wrap d-flex">

        @include('default.template-part.curriculum_item_sidebar', ['content' => $lecture])
        ...
        <div class="lecture-container">
            ...
            @if($isOpen)
                @if($lecture->video_info())
                    @include('default.video-player', ['model' => $lecture])
                @endif
                ...
                @if(get_option('lms_settings.enable_discussion'))
                    @include('default.template-part.discussion', ['content' => $lecture])
                @endif
