...
@section('title-after')
    <a href="{{route('find_plugins')}}" class="btn btn-primary" > <i class="las la-plug"></i> Find new plugins </a>
@endsection
...
@section('content')
    ...
    @else
        ...
        <div class="alert alert-light bg-light d-flex">
            <div class="mr-3">
                <span class="no-plugin-icon"><i class="las la-info-circle"></i></span>
            </div>
            <div>
                <h4> No available plugins</h4>
                <p class="mb-0">Plugins extend and expand the functionality of WebAcademy. Checkout below plugins and consider using these plugins to take your application to the next level.</p>
            </div>
        </div>
