...
@section('page-header-right')
    ...
    <a href="{{route('admin_courses', ['filter_by' => 'popular'])}}" class="ml-4"> <i class="las la-bolt"></i> {{__a('popular_courses')}}  </a>
    <a href="{{route('admin_courses', ['filter_by' => 'featured'])}}" class="ml-4"> <i class="las la-bookmark"></i> {{__a('featured_courses')}}  </a>

    @if(count(request()->input()))
        <a href="{{route('admin_courses')}}" class="ml-4"> <i class="las la-arrow-circle-left"></i> {{__a('reset_filter')}}  </a>
    @endif
@endsection
                ...
                <div class="col-md-12">
                    <div class="search-filter-form-wrap mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" class="btn btn-primary btn-purple"><i class="las la-search-plus"></i> Filter results</button>
                        </div>
