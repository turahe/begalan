...
@section('page-header-right')
    <a href="{{route('admin.posts.create')}}" class="btn btn-success" data-toggle="tooltip" title="@lang('admin.create_new_post')}}">
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.posts.show', $post)}}" class="btn btn-purple">
