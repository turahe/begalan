        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <a href="{{route('load_filemanager')}}" data-toggle="tooltip" title="" id="button-refresh" class="btn btn-default" data-original-title="Refresh">
                        <i class="las la-refresh"></i></a>

                    <button type="button" data-toggle="tooltip" title="Upload" id="button-upload" class="btn btn-primary">
                        <i class="las la-upload"></i></button>
                    <button type="button" data-toggle="tooltip" title="Insert Media" class="btn btn-info mediaInsertBtn">
                        <i class="las la-plus-circle"></i></button>
                    <button type="button" data-toggle="tooltip" title="Delete" id="button-delete" class="btn btn-danger">
                        <i class="las la-trash-o"></i></button>
                </div>
            ...
            <div class="media-modal-wrap d-flex">
                ...
                <div class="media-modal-info-wrap bg-light p-3">
                    ...
                    <button type="button" class="btn btn-info mediaInsertBtn">
                        <i class="las la-plus-circle"></i> {{__a('insert_selected_media')}}
                    </button>
